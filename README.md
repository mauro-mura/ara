...
| `costInputPer1kTokens` / `costOutputPer1kTokens` | `0.0` | Unit prices used for cost accounting |
| `costBudget` (`BigDecimal`) | `null` | Spending cap for the agent; `costBudgetCurrency` defaults to `"EUR"` |
